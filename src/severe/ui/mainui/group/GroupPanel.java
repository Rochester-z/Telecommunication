package severe.ui.mainui.group;

import severe.ui.common.MyScrollBarUI;
import severe.ui.mainui.MyTreeNode;
import severe.ui.mainui.MyTreeUI;
import severe.ui.mainui.TreeUtils;
...
public class GroupPanel extends JPanel {
	...
	public GroupPanel() {
        ...
        MyTreeNode cate1 = new MyTreeNode(new ImageIcon("image/arrow_left.png"), "我的QQ群1");
        for (int j = 1; j <= 3; j++) {
        ...
        MyTreeNode cate2 = new MyTreeNode(new ImageIcon("image/arrow_left.png"), "我的QQ群2");
        for (int j = 1; j <= 3; j++) {
